...
если он хочет записаться к врачу - make_appointment, название врача если есть в тексте и этот врач существует, иначе None, все через запятую
если он говорит об медицинском полисе напиши - policy
если он говорит, что хочет изменить полис напиши - edit_policy
если он говорит о вождение, машине, водительских правах или что-то связанных с авто напиши - avto
если он говорит, что хочет поставить на транспорт, на учет, то напиши - technic
...
если он говорит что хочет получить показания счетчика, коммунальные услуги, жкх, счетчики энергии, воды и отопления напиши - score
если он задает глупый вопрос или нецензурно выражается, напиши - bad
